  ...
  return (
    ...
    className='fixed w-[100vw] h-[90vh] top-0 left-0 bg-[#45454545] flex flex-col justify-center items-center p-3'>
      <div className='rounded bg-gray-500 text-white font-semibold text-xl p-4 max-w-[500px] text-center '>
        ...
        <span className="text-sm "> This website is made with <FiHeart className='inline text-red-700 fill-red-700 g-red-700 ' /> by&nbsp;
          <a className='text-yellow-400 underline' href="https://www.linkedin.com/in/ajaydewangan1100/" target="_blank">Ajay</a>.</span>
      </div>
